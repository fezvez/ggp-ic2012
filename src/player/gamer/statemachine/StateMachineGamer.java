 ...
 * @author Sam
 */
public abstract class StateMachineGamer extends SingleGameGamer
{
    // =====================================================================
    ...
    protected final void switchStateMachine(StateMachine newStateMachine) {
        try {        
            ...
            Role newRole = newStateMachine.getRoleFromProp(getRole().getName());
	...
	@Override
	public void stopCleanup(List<GdlSentence> lastMoves) {
		try {
			stateMachine.doPerMoveWork();
