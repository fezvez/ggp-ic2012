...
public class ProjectConfiguration {
    ...
    private static final String gamesLocalDirectoryPath = "games";
    
    public static final File gameRootDirecotry = new File (gamesRootDirectoryPath);
    ...
    public static final File gameLocalDirectory = new File(gamesRootDirectoryPath, gamesLocalDirectoryPath);
