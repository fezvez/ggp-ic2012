...
<xsl:template name="main" match="/">  
  ...
  <style type="text/css" media="all"> 
    td.at {        width:  <xsl:value-of select="$width * 0.11"/>px; height: <xsl:value-of select="$height * 0.11"/>px;        border: 2px solid #000;        background-color: #88CC88;        align: center;  valign: middle;    }      
